...
@WebServlet("/bookinout-info/bookinout-update")
public class BookInOutUpdate extends HttpServlet  {
	@Override
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/user-info/user-update.jsp").forward(request, response);
	}
}
