...
<html>
	...
	<body>
		<form name="frmInsert" action="/user-info/user-insertConfirm" onsubmit="return confirmSubmitPopup('정말로 등록하겠습니까?', 'frmInsert');" method="POST">
					...
					<td class="main">
						<div class="main">
							...
							<table class="subTable1">
								...
								<tr>
									<th>이름</th>
									<td><input type="text" name="userName" value="" type="text"></td>
								</tr>
								<tr>
									<th>전화번호</th>
									<td><input type="text" name="userPhoneNum" value="" type="text"></td>
								</tr>
							</table>
						</div>
						<div class="main">
